...
I created a class-balanced dataset as a subset of CIFAR-100. Class balancing was implemented by manually selecting samples class-by-class. The total number of samples is 8192. Dataset is formed with its own `SEED`.
